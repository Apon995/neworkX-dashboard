    ...
    "
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="flex flex-col">
          <label className="text-sm text-[#1C1B1F] font-normal mb-1">
            Profile name
          </label>
          <input
            type="text"
            name="name"
            id="name"
            className="border rounded-lg p-2 text-sm outline-none focus:border-gray-800 transition-colors duration-200 border-auth-form-border text-black font-normal"
            placeholder="Rwoodruf"
          />
        </div>
